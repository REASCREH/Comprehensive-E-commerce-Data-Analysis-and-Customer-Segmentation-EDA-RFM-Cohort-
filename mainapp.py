...
# -----------------------------
    ...
    st.info(f"✅ Displayed {23} key visualizations from the comprehensive analysis")
...
# -----------------------------
    ...
    # Model selection
    model_option = st.selectbox("Choose Model:", ["Linear Regression", "LightGBM", "ANN"])
